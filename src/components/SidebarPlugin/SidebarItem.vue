          ...
          {{ link.name }}
            ...
            <template v-else>
                <div class="inner ms-3">
                    ...
                    <span v-if="titleHasMoreThan22Chars" class="nav-link-text overflow-prevent ms-2" :title="link.name"
                          v-b-tooltip.hover>{{ link.name }} <b class="caret"></b></span>
                    <span v-else class="nav-link-text overflow-prevent ms-2">{{ link.name }}</span>
                </div>
            </template>
        </a>
